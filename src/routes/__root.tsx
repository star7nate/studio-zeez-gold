...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Studio Zeez — Luxury Photography" },
      { property: "og:description", content: "Cinematic, gold-touched photography for portraits, weddings, fashion, and brands." },
